class ConfirmedResponseModel {
  ...
  double? clienttraveldistance;
  String? fundingsourcename;
  int? tsservicetype;
  int? dsnId;

  ConfirmedResponseModel(
      {this.rosterID,
      this.clientID,
      this.rESID,
      this.resName,
  ...
  ConfirmedResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    tSTravelDistance = double.parse(json['TSTravelDistance'] != null ? json['TSTravelDistance'].toString() : "0.0");
